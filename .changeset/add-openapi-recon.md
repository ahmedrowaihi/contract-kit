---
"@ahmedrowaihi/openapi-recon": major
---

New package. Reverse-engineer an OpenAPI 3.1 spec from observed HTTP traffic. Runtime-agnostic — accepts standard `Request` + `Response`, works in browsers, Node, edge runtimes, service workers.
