...
export type Circle = {
    kind: 'circle';
    radius: number & import("typia").tags.ExclusiveMinimum<0>;
};

export type Rect = {
    kind: 'rect';
    width: number & import("typia").tags.Minimum<0>;
    height: number & import("typia").tags.Minimum<0>;
};
...
export type Order = {
    ...
    petId?: number;
    quantity?: number;
    shipDate?: string & import("typia").tags.Format<"date-time">;
    /**
     * Order Status
     */
...
export type UploadPetDocumentResponse = UploadPetDocumentResponses[keyof UploadPetDocumentResponses];
...
export type SubmitTagsData = {
    body: {
        tags: Array<string & import("typia").tags.MinLength<1>> & import("typia").tags.MaxItems<5> & import("typia").tags.MinItems<1>;
    };
    path?: never;
    query?: never;
    url: '/tags';
...
export type SubmitTagsResponses = {
    /**
     * Accepted
     */
    200: {
...
export type SubmitTagsResponse = SubmitTagsResponses[keyof SubmitTagsResponses];
...
export type CreateShapeResponses = {
    /**
     * OK
     */
    200: {
...
export type CreateShapeResponse = CreateShapeResponses[keyof CreateShapeResponses];

export type SubmitMeasurementData = {
    body: {
        value: number & import("typia").tags.Minimum<0>;
    };
    path?: never;
    query?: never;
    url: '/measurements';
...
export type SubmitMeasurementResponses = {
    /**
     * OK
     */
    200: unknown;
