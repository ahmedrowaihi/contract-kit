...
export const zDeletePetData = z.object({
    body: z.never().optional(),
    path: z.object({
        petId: z.coerce.bigint().min(BigInt('-9223372036854775808'), { message: 'Invalid value: Expected int64 to be >= -9223372036854775808' }).max(BigInt('9223372036854775807'), { message: 'Invalid value: Expected int64 to be <= 9223372036854775807' })
    }),
    query: z.never().optional(),
    headers: z.object({
