...
export type SubmitTagsData = {
  body: {
    tags: Array<string & import("typia").tags.MinLength<1>> &
      import("typia").tags.MaxItems<5> &
      import("typia").tags.MinItems<1>;
  };
  path?: never;
  query?: never;
  url: "/tags";
...
export type CreateShapeResponse =
  CreateShapeResponses[keyof CreateShapeResponses];
